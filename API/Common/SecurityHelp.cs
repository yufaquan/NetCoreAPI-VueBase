...
namespace Commons
{
    ...
    public class SecurityHelp
    {
        ...
        public static SecurityHelp Init { get => GetInstance(); }

        private static readonly object _instanceLock = new object();
        private static SecurityHelp _instance = null;
        ...
        /// 对称加密类的构造函数
        /// </summary>
        public static SecurityHelp GetInstance()
        {
            if (_instance == null)
            {
                lock (_instanceLock)
